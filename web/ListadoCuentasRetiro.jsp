<%-- 
    Document   : ListadoCuentasRetiro
    Created on : 24/04/2020, 11:51:30 PM
    Author     : Josue
--%>
...
<html>
    ...
    <body>
        <div id="wrapper">
            <header>
                <h1>Búsqueda de cuentas por ID de cliente - Realizar retiro</h1>
                <nav>
                    <ul>
                        <li class="active">
            ...
            <div id="contents">
                <nav id="navForms">
                    <ul>
                        <li>
                            <div class="form1">
                                <form action="ServletListadoCuentasRet" method="post">
                                    <table id="tablaForm1">
                                        <tbody>
                                            <tr>
                                                <td class="etiqueta">
